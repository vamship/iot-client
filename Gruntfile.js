...
'                       automatically.                                           \n' +
'                                                                                \n' +
'   lint              : Lints all source and test files.                         \n' +
'                                                                                \n' +
...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
         ...
         */
        clean: {
            tempFiles: [ ENV.ROOT._tmp.getChildPath('*'),
                        '!' + ENV.ROOT._tmp.getChildPath('.keep') ],
         ...
         */
        jsbeautifier: {
            dev: [ SRC.allFilesPattern('js'), TEST.allFilesPattern('js') ]
        },
    ...
    /**
     * Linting task. Performs lint on all source and test files.
     */
